...
import { eshwar } from '../../models/eshwar.module'; // Correct the path to 'eshwar.module'

@Component({
  selector: 'app-eshwar-list', // Updated selector
  templateUrl: './eshwar-list.component.html', // Ensure the template path is correct
  styleUrls: ['./eshwar-list.component.css']
})
export class eshwarListComponent implements OnInit {
  users: eshwar[] = []; // Store user data
  currentPage: number = 1;
  itemsPerPage: number = 5; // Display 5 records per page
  editingUser: eshwar | null = null; // Track user currently being edited
